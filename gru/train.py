...
"""
Training loop and leave-one-session-out evaluation.

Model-agnostic: works with PlateauGRU or PlateauTransformer (or anything
else) as long as it implements forward(x, lengths) -> (B, T) delta-SoC
predictions -- pass the class in via `model_cls`, nothing here needs to
